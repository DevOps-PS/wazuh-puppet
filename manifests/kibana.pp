...
class wazuh::kibana (
  ...
  $kibana_app_version = '4.0.1_7.9.3-1',
  ...
  exec {'Installing Wazuh App...':
    path    => '/usr/bin',
    command => "cd /usr/share/kibana; sudo -u kibana bin/kibana-plugin install https://packages.wazuh.com/4.x/ui/kibana/wazuh_kibana-${kibana_app_version}.zip",
